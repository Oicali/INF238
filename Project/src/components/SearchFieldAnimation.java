...
public class SearchFieldAnimation extends JTextField {
    ...
    public SearchFieldAnimation() {
        super.setBackground(new Color(255, 255, 255, 0)); //  Remove background
        setOpaque(false);
        setBorder(new EmptyBorder(10, 20, 10, 50)); //  Set Right border 50
        setFont(new java.awt.Font("sansserif", 0, 14));
        setSelectionColor(new Color(80, 199, 255));
        iconSearch = new ImageIcon(getClass().getResource("/resources/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/resources/close_1.png"));
        iconLoading = new ImageIcon(getClass().getResource("/resources/loading.gif"));
